...
if(isset($_GET["sifra"])){
	...
	$izraz=$veza->prepare("select count(b.sifra) from autor a inner join post b on a.sifra=b.autor_sifra where a.sifra=:sifra");
	$izraz->execute($_GET);
	...
	<body>
		...
		<div class="row">
			...
			<div class="large-6 columns">
				...
				<?php else:?>
					Autor se ne može obrisati jer ima jedan ili više aktualnih postova.
					<?php endif;?>
			</div>
		</div>
